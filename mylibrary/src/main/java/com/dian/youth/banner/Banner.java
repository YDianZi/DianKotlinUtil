...
import com.dian.youth.banner.config.BannerConfig;
import com.dian.youth.banner.config.IndicatorConfig;
import com.dian.youth.banner.indicator.Indicator;
import com.dian.youth.banner.listener.OnBannerListener;
import com.dian.youth.banner.listener.OnPageChangeListener;
import com.dian.youth.banner.transformer.MZScaleInTransformer;
import com.dian.youth.banner.transformer.ScaleInTransformer;
import com.dian.youth.banner.util.BannerLifecycleObserver;
import com.dian.youth.banner.util.BannerLifecycleObserverAdapter;
import com.dian.youth.banner.util.BannerUtils;
import com.dian.youth.banner.util.ScrollSpeedManger;
...
//            Log.e(getContext().getString(R.string.banner_adapter_use_error));
    ...
    public Indicator getIndicator() {
        if (mIndicator == null) {
//            String string = getContext().getString(R.string.indicator_null_error);
        }
        return mIndicator;
    }
